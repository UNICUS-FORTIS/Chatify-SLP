...
final class ChannelChatViewController: UIViewController {
...
extension ChannelChatViewController: ChatInterfaceAcceptableProtocol {
    ...
    func scrollToEnd() {
        print(#function)
        let count = socketManager.channelChatRelay.value.count
        if count > 1 {
            let last = count - 1
...
extension ChannelChatViewController: UITextViewDelegate {
